...
public class SCIRPStitching extends NDLSIPCorrectionContainer {
	...
	// construction
	public SCIRPStitching(String input, String logLocation, String outputLocation, String name) {
	...
	public static void main(String[] args) throws Exception {
		...
		String input = "/home/dspace/debasis/NDL/generated_xml_data/SCRIP/in/2018.Oct.31.11.40.24.SCIRP.data.tar.gz";
		...
		SCIRPStitching p = new SCIRPStitching(input, logLocation, outputLocation, name);
